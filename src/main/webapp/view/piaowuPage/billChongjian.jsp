        ...
        <div class="topic">
            <div class="conform">
                <div class="cfD">
                    ...
                    <label><input type="radio" name="rdbill" checked onclick="showBill_shouqi()"/>&nbsp;显示已收讫待完成的货票</label>
                ...
                <center>
                    <table id="tbCourse" border="1" cellspacing="0" cellpadding="0" >
                        <tr>
                            ...
                            <td width="180px" class="tdColor">货票状态</td>
                            <td width="180px" class="tdColor">结算方式</td>
                            <td width="150px" class="tdColor">完成交易</td>
                        </tr>
...
<script type="text/javascript">
    ...
    function loadData(data) {
        ...
        $.each(data,function (i,val) {
            ...
            finish = "<a href='/bill/chongjianBill.do?billId="+val.wayBillId+" '>完成</a>";
            switch (val.billState ){
                case 2 :
