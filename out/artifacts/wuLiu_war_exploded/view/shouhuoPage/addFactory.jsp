...
<div id="pageAll">
    <div class="page ">
        ...
        <div class="banneradd bor">
            ...
            <div class="baBody">
                <form id="myForm" action="/shouhuo/addFactory.do" method="post" >
                    <div class="bbD">
                        厂商名称：<input type="text" name="name" class="input3" />
                    </div>
                    <div class="bbD">
                        <label >地址：</label>
                    ...
                    <div class="bbD">
                        厂商负责人:<input type="text" name="leader" class="input3" />
                    </div>

                    <div class="bbD">
                        负责人电话:<input type="text" name="phone" class="input3" />
                    </div>
                    <div class="bbD">
                        厂商邮箱:<input type="text" name="email" class="input3" />
                    </div>
