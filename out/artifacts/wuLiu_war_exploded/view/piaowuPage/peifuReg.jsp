                ...
                <center>
                    <table id="tbCourse" border="1" cellspacing="0" cellpadding="0" >
                        <tr>
                            ...
                            <td width="80px" class="tdColor">赔付金额</td>
                            <td width="80px" class="tdColor">查看详情</td>
                            <td width="100px" class="tdColor">赔付登记</td>
                        </tr>
...
<script type="text/javascript">
    ...
    function loadData(data) {
        ...
        $.each(data,function (i,val) {
            ...
            reg = "<a href='/bill/getBillInfo_peifu.do?showInfo=0&billId="+val.wayBillByBillId.wayBillId+" '>登记</a>";
            reg = (val.wayBillByBillId.billPeiqian != -1)?  '已登记' : reg;
            ...
            $("table").append("<tr id='trCompanyList' class='trList'>"
                ...
                + "<td>" + peiqian+"</td>"
                + "<td><a href='/bill/getBillInfo_peifu.do?showInfo=1&billId="+val.wayBillByBillId.wayBillId+" '>查看详情</a></td>"
                + "<td>" + reg  + "</td>");
